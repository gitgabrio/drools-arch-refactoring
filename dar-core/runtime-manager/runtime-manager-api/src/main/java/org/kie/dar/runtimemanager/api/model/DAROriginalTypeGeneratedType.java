 ...
 */
public class DAROriginalTypeGeneratedType implements Serializable {

    private static final long serialVersionUID = 3887366581807183963L;
    private final String originalType;
    private final String generatedType;

    public DAROriginalTypeGeneratedType(String originalType, String generatedType) {
    ...
    public String toString() {
        return "DAROriginalTypeGeneratedType{" +
    ...
    public boolean equals(Object o) {
        ...
        DAROriginalTypeGeneratedType that = (DAROriginalTypeGeneratedType) o;
