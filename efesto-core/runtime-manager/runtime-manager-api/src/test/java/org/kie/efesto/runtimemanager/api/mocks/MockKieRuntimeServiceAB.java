...
public class MockKieRuntimeServiceAB extends AbstractMockKieRuntimeService {
    ...
    private static List<FRI> managedResources = Arrays.asList(new FRI(MockEfestoInputA.class.getPackageName(), MockEfestoInputA.class.getSimpleName()),
            new FRI(MockEfestoInputB.class.getPackageName(), MockEfestoInputB.class.getSimpleName()));
