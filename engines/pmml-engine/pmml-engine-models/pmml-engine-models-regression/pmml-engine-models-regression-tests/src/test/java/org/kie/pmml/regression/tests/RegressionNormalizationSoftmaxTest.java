...
public class RegressionNormalizationSoftmaxTest extends AbstractPMMLTest {

    private static final String FILE_NAME_NO_SUFFIX = "RegressionNormalizationSoftmax";
    ...
    public void initRegressionNormalizationSoftmaxTest(double x, double y) {
        this.x = x;
        this.y = y;
    }
    ...
    void testNormalizationMethodsRegression(double x, double y) throws Exception {
        initRegressionNormalizationSoftmaxTest(x, y);
