...
public class LogisticRegressionSimplemaxNormalizationTest extends AbstractPMMLTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {5.8, 2.6, 4.0, 1.2, "versicolor", 0.165004279225608, 0.59107423809292, 0.243921482681471},
                {5.4, 3.9, 1.3, 0.4, "setosa", 1.10684700233123, -0.180527000396087, 0.0736799980648569},
        });
    }
