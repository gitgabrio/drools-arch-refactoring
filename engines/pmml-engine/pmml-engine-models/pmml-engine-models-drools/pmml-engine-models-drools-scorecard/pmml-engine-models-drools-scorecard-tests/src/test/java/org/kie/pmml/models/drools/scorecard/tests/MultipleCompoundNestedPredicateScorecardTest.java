...
public class MultipleCompoundNestedPredicateScorecardTest extends AbstractPMMLTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {-50.0, "classD", -8, "characteristic2ReasonCode", null},
                {-9.0, "classB", 75, "characteristic1ReasonCode", null},
                {25.4, "classB", 75, "characteristic1ReasonCode", null},
                {-7.0, "classA", -8, "characteristic2ReasonCode", null},
                ...
                {12.0, "classB", 75, "characteristic1ReasonCode", null},
                {12.0, "classD", 75, "characteristic1ReasonCode", null},
        });
    }
