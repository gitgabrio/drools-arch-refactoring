...
public class DARResourceIntermediateBar implements DARResourceIntermediate {

    private final String fullResourceName;
    private final String targetEngine;
    private final Object content;

    public DARResourceIntermediateBar(String fullResourceName, String targetEngine, Object content) {
